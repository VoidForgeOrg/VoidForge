...
- **Events**: `PlanetCreated(Name, SolarSystemId, IronOrePool, BuildingSlotCount, IronOreStorageCapacity, IronIngotStorageCapacity)`, `PlanetColonized(OwnerId, IronOreStored, IronIngotStored, ColonizedAt)`, `BuildingPlaced(BuildingType, PlacedAt)`, `BuildingConstructionStarted(SlotIndex, BuildingType, StartedAt, CompletesAt, DrainPerSecond)`, `BuildingCompleted(SlotIndex, CompletedAt)`
